...
public class TerrainGraphWindow : EditorWindow {
  ...
  [MenuItem("Graph/Terrain Graph 1")]
  public static void OpenTerrainGraphWindow() {
    TerrainGraphWindow window = GetWindow<TerrainGraphWindow>();
  ...
  //  //}
  //  //TerrainGraphWindow window = GetWindow<TerrainGraphWindow>();
  //  //window.terrainGenerator = tg;
  //  //window.buildGraph();
  //  //window.titleContent = new GUIContent(text: "Terrain Editor");
  //}

  //private void buildGraph() {
  //  //this.graphView.buildGraph(terrainGenerator);
  //}
  ...
  //  toolbar.Add(new Button(() => Apply()) { text = "Apply" });
...
public class TerrainGraphEditorWindow : EditorWindow {
  ...
  [MenuItem("Graph/Test Window")]
  public static void OpenTerrainGraphWindow() {
    TerrainGraphEditorWindow window = GetWindow<TerrainGraphEditorWindow>();
    window.titleContent = new GUIContent(text: "Test Editor");
  }
