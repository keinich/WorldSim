...
#endif
{
    ...
    float slope = IN.normal.y;
    float slopeThreshold = _GrassSlopeThreshold;
    albedo = half4(slope, 0.0h, 0.0h, 1.0h);
    float grassBlendAmount = 0.1f;
    ...
    //return half4(IN.normal.x, IN.normal.y, IN.normal.z, 1.0h);
